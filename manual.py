...
commands.getstatusoutput('sudo virt-install --vnc --vnclisten='+cl_ip+' --vncport='+r+' --noautoconsole --name '+userid+' --ram '+ram+' --vcpu '+cpu+' --disk path=/var/lib/libvirt/images/ubuntu.qcow2,size='+size+' --cdrom /ubuntu.iso')
